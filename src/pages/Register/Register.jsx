        ...
        <div className="bg-white pt-5 rounded-xl">
          ...
          >
            ...
            <div className="mt-2">
              ...
              {errors.role && (
                <p className="text-red-400 text-[15px]">Enter Your Role!</p>
              )}
            </div>
            <div className="mt-2">
              <input
              ...
              />
              {errors.email && (
                <p className="text-red-400 text-[15px]">Enter Your Email!</p>
              )}
            </div>
            <div className="mt-2">
              <input
            ...
            <div className="mt-2 relative">
              ...
              {errors.password && (
                <p className="text-red-400 text-[15px]">Enter Your Password!</p>
              )}
              {error && (
                <p className="text-red-400 text-justify text-[15px] w-[400px]">
                  {error}
                </p>
              )}
              {success && (
