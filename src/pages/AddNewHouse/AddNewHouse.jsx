...
const AddNewHouse = () => {
  ...
  const handleAddNewHouse = (event) => {
    ...
    fetch("https://house-hunter-server-pi.vercel.app/houses", {
      method: "POST",
      headers: {
        "content-type": "application/json",
      },
      body: JSON.stringify(newHouseInfo),
    })
      .then((res) => res.json())
      .then((data) => {
        if (data.insertedId) {
          ...
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              <h2 className=" text-2xl font-medium leading-7 text-gray-900">
                Add a <span className="text-[var(--primary-color)]">House</span>
              </h2>
                  ...
                  <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                    <div className="text-center w-full md:w-10/12">
                      ...
                      <p className="text-xs leading-5 text-gray-600">
                        Choose only http or https house photo link
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <p className="mt-1 text-md leading-6 text-gray-600">
                Please provide valid information for submit a house
              </p>
