    ...
    swalWithBootstrapButtons
      ...
      .then((result) => {
        if (result.isConfirmed) {
          ...
          fetch(`https://house-hunter-server-pi.vercel.app/allBookings/${id}`, {
            method: "DELETE",
          })
            .then((res) => res.json())
            .then((data) => {
  ...
  return (
    <div>
      ...
      <p className="text-[15px] text-gray-500 border-b pb-2 mb-3">
        You can booked 2 house at a time, if you need add book more you need to
