  ...
  return (
    <div className="my-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7 my-12 px-5">
        <div className="lg:flex gap-3 items-center rounded-md bg-gray-50 shadow-lg border">
          <img
        ...
        {/* <div className="lg:flex gap-3 items-center rounded-md bg-gray-50 shadow-lg border">
          <img
            className="w-72 h-full rounded-md"
            src="https://img.freepik.com/free-photo/full-shot-athlete-swimming-pool_23-2149028360.jpg?w=740&t=st=1704170958~exp=1704171558~hmac=951b831b4bf50260289982b6496b02b80e3d05615ec17a1445afa8066cb23a32"
            alt=""
          />
          <div className="space-y-5 py-3">
            ...
            <h1 className="font-semibold text-2xl">Swimming Pool</h1>
            <p>
              This is the dolor sit amet adipisicing elit. Ducimus corrupti sit
              amet tempore placeat ipsa.
            </p>
        ...
        <div className="lg:flex gap-3 items-center rounded-md bg-gray-50 shadow-lg border">
          <img
            ...
            src="https://img.freepik.com/free-photo/empty-underground-parking-bay_60438-3915.jpg?t=st=1704171001~exp=1704174601~hmac=9e85990accdb303a0e9950730aafbcfbe75714f9ac1c70ee7d755a9e4346de51&w=826"
            alt=""
          />
          <div className="space-y-5 py-3">
            <div className="flex justify-between items-center mx-3">
            ...
            <h1 className="font-semibold text-2xl">Our Parking</h1>
            <p>
              This is the dolor sit amet adipisicing elit. Ducimus corrupti sit
              amet tempore placeat ipsa.
            </p>
